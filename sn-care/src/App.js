  ...
  return (
    <div className="App" id='App'>
      <Routes>
        ...
        <Route path='/success-alert' element={<SuccessAlert work='Registeration' description ='Now you can use your credentials to login to the system.' navigation='/login' status='success'></SuccessAlert>}></Route>
