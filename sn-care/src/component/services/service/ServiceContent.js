       ...
       <div className='mobile-s-content'>
          <div className='m-s-row'>
            <div className='m-s-content'>
                <img src={img1} alt='m-s-1' width='30%' className='m-s-img'></img>
                <p className='m-s-service'>24/7 Service</p>
            </div>
            <div className='m-s-content'>
                <img src={img2} alt='m-s-2' width='30%' className='m-s-img'></img>
                <p className='m-s-service'>Online Booking</p>
            </div>
          </div>
          <div className='m-s-row'>
            <div className='m-s-content'>
                <img src={img3} alt='m-s-3' width='30%' className='m-s-img'></img>
                <p className='m-s-service'>Health Information & Resources</p>
            </div>
            <div className='m-s-content'>
                <img src={img4} alt='m-s-4' width='30%' className='m-s-img'></img>
